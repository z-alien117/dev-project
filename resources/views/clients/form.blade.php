            ...
            <form class="mb-0" id="DynamicForm" name="template-contactform" action="{{route('functions.update_client', ['client_update'=>$client->id])}}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" id="template-contactform-name" name="name" id="name" value="{{$client->name}}" class="sm-form-control required" />
                    </div>
    ...
    @slot('content')
        <form class="mb-0" id="DynamicForm" name="template-contactform" action="{{route('functions.store_client')}}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <label for="template-contactform-name">Name <small>*</small></label>
                    <input type="text" id="template-contactform-name" name="name" id="name" value="" class="sm-form-control required" />
                </div>
